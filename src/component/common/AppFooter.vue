<template>
    <div class="footer-bar">
        <div class="footer-left">
            <BaseButton v-if="showBack" type="soft" :icon="backIcon" @confirm="$emit('back')" />

            <DropdownButton v-model="localLang" :items="languageOptions" type="soft" textColor="link"
            ...
            <BaseButton type="primary" :icon="bellIcon" textColor="inverse" @confirm="$emit('call-staff')">
        ...
        <div class="footer-right">
            <BaseButton v-if="showCart" type="primary" :icon="cartIcon" textColor="inverse"
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const showBack = computed(() =>
            props.mode === FooterMode.Category
        );
